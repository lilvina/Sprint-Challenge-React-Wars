...
- ReactJS is a UI component library and was built by Facebook to create an interactive, stateful and resuable UI components. It solves the problems by using a virtual DOM, that updates the DOM without having the page to reload.

- [ ] What does it mean to _think_ in react?
- I'm not quite sure because this wasn't discussed much. I would in order to think in React, you have to think how React is built differently compared to other frameworks and how each component should only perform one function.
...
- [ ] Describe props.
- Props stands for properties and it holds immutable data, which cannot be changed, that is passed to the components.
